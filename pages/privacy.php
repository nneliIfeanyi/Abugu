...
<body class="privacy-page">
    ...
    <main class="main">
        ...
        <!-- Page Title -->
        <div class="page-title dark-background" style="background-image: url(<?php echo URLROOT; ?>/assets/img/education/img-2.jpg);">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="privacy-header" data-aos="fade-up">
                    <div class="header-content">
                        ...
                        <p class="intro-text">This Privacy Policy describes how we collect, use, process, and disclose your information, including personal information, in conjunction with your access to and use of this website.</p>
                    </div>
                </div>
                ...
                <div class="privacy-content" data-aos="fade-up">
                    ...
                    <div class="content-section">
                        ...
                        <p>When you use this website, you're trusting us with your information. We understand this is a big responsibility and work hard to protect your information and put you in control.</p>
                    ...
                    <div class="content-section">
                        ...
                        <p>When you create an account or use this website, you provide us with personal information that includes:</p>
                        <ul>
                        ...
                        <p>We may automatically collect and store certain information when you use this website:</p>
                        <ul>
                    ...
                    <div class="content-section">
                        ...
                        <p>We work hard to protect our users/students from unauthorized access to or unauthorized alteration, disclosure, or destruction of information we hold. In particular:</p>
                        <ul>
                ...
                <div class="privacy-contact" data-aos="fade-up">
                    ...
                    <div class="contact-details">
                        <p><strong>Email:</strong> stmarypolytechnic@gmail.com</p>
                        <p><strong>Address:</strong> Old Niger Motel Road Suleja, Niger State.</p>
                    </div>
                </div>
