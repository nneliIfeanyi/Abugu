...
<ul class="app-menu">
<li><a class="app-menu__item active" href="<?php echo URLROOT;?>/student"><i class="app-menu__icon feather icon-monitor"></i><span class="app-menu__label">Dashboard</span></a></li>
