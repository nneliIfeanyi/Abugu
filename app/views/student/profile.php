					...
					<div class="tile">
						<div class="tile-body">
							<div class="table-responsive">
								...
								<?php if (empty($this->details->passport)): ?>
									<form enctype="multipart/form-data" action="<?php echo URLROOT; ?>/users/passport" method="POST">
										<input type="hidden" name="id" value="<?php echo $this->details->id; ?>">

										<div class="mb-3">
											<label class="form-label">Your passport</label>
											<input name="passport" class="form-control" required type="file" accept=".png, .jpg, .jpeg">
										</div>
										<div class="mb-3">
								...
								<?php if (empty($this->details->olevelDoc)): ?>
								...
								<?php else: ?>
									<div class="alert alert-dismissible alert-info">
										<strong> &nbsp;Olevel Doc. uploaded successfully.</strong>
									</div>
								<?php endif; ?>
